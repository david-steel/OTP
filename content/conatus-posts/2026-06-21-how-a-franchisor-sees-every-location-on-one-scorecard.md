---
title: How a franchisor sees every location on one scorecard
date: 2026-06-21
author: David Steel
slug: how-a-franchisor-sees-every-location-on-one-scorecard
type: founder_essay
status: published
series: franchise
series_part: 5
description: Before OTP portfolio: visibility lag, location silos, no one chart to run. After: every location rolls its KPIs up into one view, corporate sets the standard once, and the underperformer is never invisible.
---

# How a franchisor sees every location on one scorecard
