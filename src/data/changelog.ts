...
<p>The <a href="/me/todos" class="text-otp-600 hover:text-otp-500 underline">/me/todos</a> page was rebuilt as a thumb-reachable mobile app: sticky bottom add bar that's always visible (one input + send, no priority/date upfront -- those live in the per-todo Edit drawer), <strong>swipe-left-to-complete</strong> on any card, iOS safe-area padding so the FAB clears the home indicator, and a PWA install nudge so you can drop the app on your home screen and treat it like any other phone app. Theme color matches the rest of the brand (Ollie lime). Desktop layout is unchanged.</p>
...
<p>The /sign-up page now matches the home page visual language: light editorial backdrop, mono <code>[OTP]</code> lockup in a minimal nav (logo + Sign in, no exit ramps), big Schibsted Grotesk hero, and Clerk's SignUp widget themed to the Ollie green primary on dark ink text. A "What happens next" sidebar with hand-1 / hand-2 / hand-3 numbering tells new founders the three steps after submission. Loading skeleton inside the Clerk slot replaces the empty-box-while-the-widget-loads dead time.</p>
...
<p>Founder badge for any claimed coach: <a href="/public/images/founder-coach-badge.png" class="text-otp-600 hover:text-otp-500 underline">download the PNG</a>. The Founding 25 still has open seats -- see <a href="/coach" class="text-otp-600 hover:text-otp-500 underline">/coach</a> for the playbook.</p>`,
...

  {
    ...
    details: `<p><a href="https://orger.ai" class="text-otp-600 hover:text-otp-500 underline">Orger.ai</a> shipped today with a new homepage, a mascot named Ollie, and a free builder that lets you drag and drop the humans you have and get grounded recommendations for the AI agents you should hire next.</p>
