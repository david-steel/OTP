...
app.addHook('onSend', async (request, reply) => {
  ...
  reply.header(
    ...
    "default-src 'self'; script-src 'self' 'unsafe-inline' data: https://seo.sneeze.it https://www.googletagmanager.com https://googleads.g.doubleclick.net https://www.google.com https://cdn.tailwindcss.com https://*.clerk.accounts.dev https://*.clerk.com https://clerk.orgtp.com https://d3js.org https://challenges.cloudflare.com https://hcaptcha.com https://*.hcaptcha.com https://assets.calendly.com; worker-src 'self' blob:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://hcaptcha.com https://*.hcaptcha.com https://assets.calendly.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https:; connect-src 'self' https://seo.sneeze.it https://sa.searchatlas.com https://*.clerk.dev https://*.clerk.com https://*.clerk.accounts.dev https://clerk.orgtp.com https://www.google-analytics.com https://www.google.com https://googleads.g.doubleclick.net https://orgtp.com https://challenges.cloudflare.com https://hcaptcha.com https://*.hcaptcha.com https://calendly.com; frame-src 'self' https://*.clerk.accounts.dev https://*.clerk.com https://clerk.orgtp.com https://www.youtube.com https://challenges.cloudflare.com https://hcaptcha.com https://*.hcaptcha.com https://calendly.com;"
  );
...
app.get('/sitemap.xml', async (request, reply) => {
  ...
  const staticPages = [
    ...
    // Marketing / SEO landing pages (sitelinks + outreach destinations).
    { loc: '/foundation', priority: '0.8', changefreq: 'monthly' },
    { loc: '/partners', priority: '0.8', changefreq: 'monthly' },
    { loc: '/marketplace', priority: '0.8', changefreq: 'weekly' },
    { loc: '/free-agents', priority: '0.8', changefreq: 'monthly' },
    { loc: '/free-account', priority: '0.8', changefreq: 'monthly' },
    { loc: '/fix-accountability-gaps', priority: '0.8', changefreq: 'monthly' },
    { loc: '/level-10-meetings', priority: '0.8', changefreq: 'monthly' },
    { loc: '/the-otp-difference', priority: '0.8', changefreq: 'monthly' },
    { loc: '/coach', priority: '0.8', changefreq: 'monthly' },
    { loc: '/coaches', priority: '0.7', changefreq: 'weekly' },
    { loc: '/agent-onboarding', priority: '0.7', changefreq: 'monthly' },
    { loc: '/machine-commerce', priority: '0.7', changefreq: 'monthly' },
    { loc: '/checkup', priority: '0.7', changefreq: 'monthly' },
    ...
    { loc: '/blog/entrepreneurial-operating-system-guide', priority: '0.8', changefreq: 'monthly' },
    { loc: '/blog/what-is-an-integrator', priority: '0.8', changefreq: 'monthly' },
    { loc: '/blog/what-is-eos', priority: '0.8', changefreq: 'monthly' },
    { loc: '/blog/measurables', priority: '0.8', changefreq: 'monthly' },
    { loc: '/blog/operating-software', priority: '0.8', changefreq: 'monthly' },
    { loc: '/blog/define-entrepreneurial', priority: '0.8', changefreq: 'monthly' },
    { loc: '/blog/the-maestro-problem', priority: '0.8', changefreq: 'monthly' },
    { loc: '/blog/maestro-resume', priority: '0.8', changefreq: 'monthly' },
    { loc: '/blog/when-the-maestro-quits', priority: '0.8', changefreq: 'monthly' },
