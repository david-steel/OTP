...
app.addHook('onSend', async (request, reply) => {
  ...
  reply.header(
    ...
    "default-src 'self'; script-src 'self' 'unsafe-inline' data: https://seo.sneeze.it https://www.googletagmanager.com https://googleads.g.doubleclick.net https://www.google.com https://cdn.tailwindcss.com https://*.clerk.accounts.dev https://*.clerk.com https://clerk.orgtp.com https://d3js.org https://challenges.cloudflare.com https://hcaptcha.com https://*.hcaptcha.com https://assets.calendly.com; worker-src 'self' blob:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://hcaptcha.com https://*.hcaptcha.com https://assets.calendly.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https:; connect-src 'self' https://seo.sneeze.it https://*.clerk.dev https://*.clerk.com https://*.clerk.accounts.dev https://clerk.orgtp.com https://www.google-analytics.com https://www.google.com https://googleads.g.doubleclick.net https://orgtp.com https://challenges.cloudflare.com https://hcaptcha.com https://*.hcaptcha.com https://calendly.com; frame-src 'self' https://*.clerk.accounts.dev https://*.clerk.com https://clerk.orgtp.com https://www.youtube.com https://challenges.cloudflare.com https://hcaptcha.com https://*.hcaptcha.com https://calendly.com;"
  );
