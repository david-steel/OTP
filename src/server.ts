...
app.addHook('onSend', async (request, reply) => {
  ...
  reply.header(
    ...
    "default-src 'self'; script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://*.clerk.accounts.dev https://*.clerk.com https://clerk.orgtp.com https://d3js.org https://challenges.cloudflare.com https://hcaptcha.com https://*.hcaptcha.com; worker-src 'self' blob:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://hcaptcha.com https://*.hcaptcha.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https:; connect-src 'self' https://*.clerk.dev https://*.clerk.com https://*.clerk.accounts.dev https://clerk.orgtp.com https://www.google-analytics.com https://orgtp.com https://challenges.cloudflare.com https://hcaptcha.com https://*.hcaptcha.com; frame-src https://*.clerk.accounts.dev https://*.clerk.com https://clerk.orgtp.com https://www.youtube.com https://challenges.cloudflare.com https://hcaptcha.com https://*.hcaptcha.com;"
  );
